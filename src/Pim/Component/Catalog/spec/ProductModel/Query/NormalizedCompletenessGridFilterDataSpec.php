...
class NormalizedCompletenessGridFilterDataSpec extends ObjectBehavior
{
    function let()
    {
        $this->beConstructedWith([
            ...
            ['channel_code' => 'ecommerce', 'locale_code' => 'en_US',  'complete' => "0", 'incomplete' => "1"],
            ['channel_code' => 'ecommerce', 'locale_code' => 'fr_FR', 'complete' => "1", 'incomplete' => "0"],
            ['channel_code' => 'ecommerce', 'locale_code' => 'fr_FR', 'complete' => "0", 'incomplete' => "0"],
            ['channel_code' => 'print', 'locale_code' => 'en_US', 'complete' => "1", 'incomplete' => "0"],
            ['channel_code' => 'print', 'locale_code' => 'en_US', 'complete' => "0", 'incomplete' => "0"],
            ['channel_code' => 'print', 'locale_code' => 'fr_FR', 'complete' => "1", 'incomplete' => "0"],
            ['channel_code' => 'print', 'locale_code' => 'fr_FR', 'complete' => "0", 'incomplete' => "0"],
        ]);
    }
